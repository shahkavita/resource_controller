            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-pencil-square"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{route('customerlist.index')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Customer List</p>
                            </a> </li>
                            <li class="nav-item"> <a href="{{route('customerlist.create')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Add Customer</p>
                            </a> </li>
                    </ul>
                </li>
